...
export class ApiKeyPermissions implements OnInit {
  ...
  public ngOnInit(): void {
    this.permissionsConfig.set({
      ...
      getEntity: (id: string) => this.apiKeysService.getApiKeyById(id),
      getPermissions: (id: string) => this.apiKeysService.getApiKeyPermissions(id),
      getResourcesPermissions: () => this.apiKeysService.getApiKeyResourcesPermissions(),
      updatePermissions: (id: string, permissionIds: string[]) =>
        this.apiKeysService.updateApiKeyPermissions(id, permissionIds),
